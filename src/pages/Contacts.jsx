    ...
    <>
      ...
      <div className="map container">
        ...
        <iframe
          ...
          width="600"
          height="450"
          style={{ border: 0 }} // Виправлено: стилі передаються як об'єкт
          allowFullScreen="" // Виправлено: CamelCase
          loading="lazy"
          referrerPolicy="no-referrer-when-downgrade" // Виправлено: CamelCase
        ></iframe>
      </div>
    </>
  );
